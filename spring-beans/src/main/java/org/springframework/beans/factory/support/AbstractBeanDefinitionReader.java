...
public abstract class AbstractBeanDefinitionReader implements EnvironmentCapable, BeanDefinitionReader {
	...
	public int loadBeanDefinitions(String location, @Nullable Set<Resource> actualResources) throws BeanDefinitionStoreException {
		// resourceLoader--> Root WebApplicationContext(XmlWebApplicationContext)
		...
		if (resourceLoader instanceof ResourcePatternResolver) {
			...
			try {
				// 委托ResourceLoader将配置文件封装成Resource
				// Resource也是一个接口体系，在web环境下，这里就是ServletContextResource 
				// XmlWebApplicationContext看UML图就知道继承自ResourcePatternResolver
				Resource[] resources = ((ResourcePatternResolver) resourceLoader).getResources(location);
				// loadBeanDefinitions(),对Resource进行解析 
